 ...
 */
class FrontendLogin extends AbstractController
{
    /**
     * @return string[]
     */
    ...
    public function run(): Notification|View
    {
        ...
        $userAdvertsCount = !$this->getCurrentUser()->isGuest()
            ? $this->getMapper(AdvertMapper::class)->findUserAdvertsCount($this->getCurrentUser()->getId())
            : null;

        $this->getView()->getStorage()->offsetSet('userAdvertsCount', $userAdvertsCount);
